...
public class ContactActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //resultCode:setResult(0, intent);與setResult(Activity.RESULT_OK, intent);不會出現空指針異常
    ...
    private ArrayList<HashMap<String, String>> readContact() {
        ...
        //然后，根据mimetype来区分哪个市联系人，哪个是电话号码
        ...
        if (rawContactsCursor != null) {
            while (rawContactsCursor.moveToNext()) {
                ...
                //其次，根据contact_id从data表中查询出相应的电话号码和联系人名称，实际上查询的是视图view_data
                ...
                if (dataCursor != null) {
                    ...
                    while (dataCursor.moveToNext()) {
                        ...
                        //Log.i(TAG, "contactId=:"+contactId + "data1=:"+data1 +"mimetype=:"+ mimetype);
